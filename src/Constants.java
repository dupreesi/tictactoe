public class Constants {
    ...
    public static final String MSG_NO_GAME_MODE = "No game mode selected. Exiting...";
    public static final String MSG_NO_DIFFICULTY = "No difficulty selected. Exiting...";
    ...
    public static final String MSG_GAME_MODE_SELECTED = "Selected: ";
    ...
    public static final String MSG_DIFFICULTY_PROMPT = "Select computer difficulty level:";
    public static final String MSG_DIFFICULTY_OPTION = "%s - %s%n";
    public static final String MSG_DIFFICULTY_SELECTED = "Computer difficulty level set to: ";
}
